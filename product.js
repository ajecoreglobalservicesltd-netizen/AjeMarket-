...
async function load() {
    ...
    <div class="product">
      ...
      <div class="panel">
        ...
        <div class="actions">
          ...
          <button class="btn secondary" id="fav" type="button">♡ Save</button>
          <button class="btn danger" id="report" type="button">Report</button>
        </div>
  ...
  if (report) {
    report.onclick = async () => {
      ...
      try {
        /*
          Your reports table uses target_type rather than product_id.
          A product report is therefore stored as:
            target_type = "product"
